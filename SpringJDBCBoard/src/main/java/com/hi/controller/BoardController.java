...
import com.hi.service.BoardSeviceImpl;
...
public class BoardController {
	...
	BoardController(BoardSeviceImpl boardSeviceImpl) {
		this.boardSeviceImpl = boardSeviceImpl;
	}
	...
	public String boardList(Model model) throws Exception {
		List<BoardDTO> list = boardSeviceImpl.list();
	...
	public String boardSelect(BoardDTO boardDto, Model model) throws Exception {
		...
		boardDto = boardSeviceImpl.select(boardDto);
		if (boardDto == null) {
			return "board/false";
		}
		model.addAttribute("boardDto", boardDto);
	...
	public String boardDelete(BoardDTO boardDto, Model model) throws Exception {
		...
		boolean result = boardSeviceImpl.delete(boardDto);
		if (result == false) {
			return "board/false";
		}
	...
	public String boardUpdate(BoardDTO boardDto, Model model) throws Exception {
		...
		boolean result= boardSeviceImpl.update(boardDto);
